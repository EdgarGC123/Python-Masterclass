...
button = Button(frame,text="Add New Entry",command=lambda: get_data(entry_name.get(),entry_age.get(),entry_address.get()))
button.grid(row=4,column=1)



# searching by id section
